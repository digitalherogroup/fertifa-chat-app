                    ...
                    <div class="invoice-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row ml-0 mr-0 cloneInvoice" id="cloneNewInvoice">
                                    <div class="col-5 padding">
                                        <label for="description" class="custom-label select p-0">Custom item
                                            type</label>
                        ...
                        <div class="invoice-footer">
                            ...
                            <div class="padding invoice-tax final-total custom-final-total" id="finalTotal">
                                ...
                                <input type="number" id="totalFinal" name="total" class="total" placeholder="0.00"
                                       disabled>
                                <span class="pound">
                                        <i class="fa fa-pound-sign" aria-hidden="true"></i>
                                    </span>
...
<script>
   let roomIdFromFrontUser = ${fromId}
</script>
<c:if test="${fromId < 10}">
